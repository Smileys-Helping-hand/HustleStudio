...
const firebaseConfig = {
  ...
  messagingSenderId:
    import.meta.env.VITE_FIREBASE_SENDER_ID || process.env.FIREBASE_SENDER_ID || '',
  appId: import.meta.env.VITE_FIREBASE_APP_ID || process.env.FIREBASE_APP_ID || '',
  measurementId:
    import.meta.env.VITE_FIREBASE_MEASUREMENT_ID || process.env.FIREBASE_MEASUREMENT_ID,
};
