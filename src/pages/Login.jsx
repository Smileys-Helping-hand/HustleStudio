    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-black via-zinc-900 to-zinc-950 px-4">
      ...
      >
        <div className="mb-8 text-center">
          ...
          <p className="text-sm text-white/60">Log in to manage your Side Hustle Studio operations.</p>
        </div>
        ...
        <div className="mt-8 space-y-3">
          <p className="text-xs font-semibold uppercase tracking-widest text-white/40">Quick presets</p>
