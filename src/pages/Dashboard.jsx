...
const Dashboard = ({ introComplete }) => {
  ...
  useEffect(() => {
    ...
    import('recharts')
      ...
      .catch(() => {
        /* ignore lazy load failure - charts will not render */
      });
    return () => {
      active = false;
    };
            ...
            {Recharts ? (
              <Recharts.ResponsiveContainer width="100%" height="100%">
                <Recharts.LineChart data={chartData}>
                  ...
                  <Recharts.XAxis dataKey="day" stroke="#aaa" />
                  <Recharts.YAxis stroke="#aaa" tickFormatter={(value) => `R${value}`} />
                  <Recharts.Tooltip
                    contentStyle={{
                  ...
                  />
                  <Recharts.Line type="monotone" dataKey="revenue" stroke="url(#lineGradient)" strokeWidth={3} dot={false} />
                </Recharts.LineChart>
